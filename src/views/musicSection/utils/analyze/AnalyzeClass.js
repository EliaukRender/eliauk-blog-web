 ...
 * @return
 */
import renderAnalyze from '@/views/musicSection/utils/analyze/renderAnalyze';
import { getGradient } from '@/views/musicSection/utils/analyze/tools';
...
class AnalyzeClass {
	...
	constructor(audio, analyser, canvas, options = {}) {
		...
		if (this.options.isGradient) {
			this.options.gradient = getGradient(this.canvasCtx, this.canvas.width, this.options.colors);
		}
